...
<body>
	...
	<div class="container theme-showcase" role="main">
		<button type="button" onclick="history.back(-1)" class="btn btn-default btn-sm float-right">
	  	...
	  	<br></br>
		<form action="<%=basePath%>dispatch/record_checksubmit" method="get" class="form-inline">
		<div class="panel panel-default">
  			...
  			<table class="table">
				...
				<c:forEach items="${record_opdetail}" var="node">
					<tr>
						<td> 
						...
						<td> <c:out value="${node.reason_pos}"></c:out> </td>
					</tr>
	   			</c:forEach>
  			</table>
		</div>
		
		<label>出库员：	<input style="width: 200px;" type="text" name="manager" class="form-control" placeholder = "出库员名称"></label>
		<br></br>
		...
		<input type="hidden" name="application_order" value="${record_opdetail[0].order}">
