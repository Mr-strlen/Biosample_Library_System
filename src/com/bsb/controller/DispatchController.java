...
public class DispatchController {
	...
	/*// 申请单个
	@RequestMapping("/apply_deliverdetail")
	public ModelAndView getApplyDe(String type, String snum, String condition){
        // ModelAndView mv = new ModelAndView("DispatchApplySum");
        int anum = dispatchService.getApplyNum();
		anum = anum + 1;
		String order = "DA" + String.valueOf(anum);
		System.out.println("*******" + type + snum + condition);
		int num = Integer.valueOf(snum);
		
		dispatchService.insertApplyDe(order, type, num, condition, "待审核");       
